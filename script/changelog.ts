...
Generates UPCOMING_CHANGELOG.md by running the OPENCRAFT changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for OPENCRAFT run (default: low)
      --quiet            Suppress OPENCRAFT command output unless it fails
