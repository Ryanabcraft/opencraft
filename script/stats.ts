...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/OPENCRAFT/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/OPENCRAFT...\n")
...
console.log("Fetching npm all-time downloads for OPENCRAFT-ai...\n")
const npmDownloads = await fetchNpmDownloads("OPENCRAFT-ai")
