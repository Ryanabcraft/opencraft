...
const releaseId = process.env.OPENCRAFT_RELEASE
if (!releaseId) throw new Error("OPENCRAFT_RELEASE is required")

const version = process.env.OPENCRAFT_VERSION
if (!version) throw new Error("OPENCRAFT_VERSION is required")
...
const macxTarGz = "OPENCRAFT-desktop-mac-x64.app.tar.gz"
const macaTarGz = "OPENCRAFT-desktop-mac-arm64.app.tar.gz"
