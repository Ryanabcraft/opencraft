...
// test/preload.ts pins OPENCRAFT_MODELS_PATH to a fixture so other tests can
...
// bun process.
const ORIGINAL_MODELS_PATH = Flag.OPENCRAFT_MODELS_PATH
const ORIGINAL_DISABLE_FETCH = Flag.OPENCRAFT_DISABLE_MODELS_FETCH
beforeAll(() => {
  Flag.OPENCRAFT_MODELS_PATH = undefined
  Flag.OPENCRAFT_DISABLE_MODELS_FETCH = true
})
afterAll(() => {
  Flag.OPENCRAFT_MODELS_PATH = ORIGINAL_MODELS_PATH
  Flag.OPENCRAFT_DISABLE_MODELS_FETCH = ORIGINAL_DISABLE_FETCH
})
