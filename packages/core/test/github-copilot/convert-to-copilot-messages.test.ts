import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@OPENCRAFT-ai/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
