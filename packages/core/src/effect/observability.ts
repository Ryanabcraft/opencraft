...
import { ensureProcessMetadata } from "../util/OPENCRAFT-process"
...
export function resource(): { serviceName: string; serviceVersion: string; attributes: Record<string, string> } {
  ...
  return {
    ...
    attributes: {
      ...
      "OPENCRAFT.client": Flag.OPENCRAFT_CLIENT,
      "OPENCRAFT.process_role": processMetadata.processRole,
      "OPENCRAFT.run_id": processMetadata.runID,
