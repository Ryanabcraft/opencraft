import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@OPENCRAFT-ai/sdk/v2"
import { SessionTurn } from "@OPENCRAFT-ai/ui/session-turn"
import { SessionReview } from "@OPENCRAFT-ai/ui/session-review"
import { DataProvider } from "@OPENCRAFT-ai/ui/context"
import { FileComponentProvider } from "@OPENCRAFT-ai/ui/context/file"
import { WorkerPoolProvider } from "@OPENCRAFT-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@OPENCRAFT-ai/ui/logo"
import { IconButton } from "@OPENCRAFT-ai/ui/icon-button"
import { ProviderIcon } from "@OPENCRAFT-ai/ui/provider-icon"
import { iife } from "@OPENCRAFT-ai/core/util/iife"
import { Binary } from "@OPENCRAFT-ai/core/util/binary"
import { NamedError } from "@OPENCRAFT-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@OPENCRAFT-ai/ui/tabs"
import { MessageNav } from "@OPENCRAFT-ai/ui/message-nav"
import { FileSSR } from "@OPENCRAFT-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@OPENCRAFT-ai/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/OPENCRAFT-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | OPENCRAFT</Title>
              </Show>
              <Meta name="description" content="OPENCRAFT - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/anomalyco/OPENCRAFT"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
                              <IconButton
                                as={"a"}
                                href="https://OPENCRAFT.ai/discord"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />
