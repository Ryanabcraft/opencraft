...
const directory = "C:/OPENCRAFT/SmokeProject"
const projectID = "proj_smoke_timeline"
const model = { providerID: "OPENCRAFT", modelID: "claude-opus-4-6", variant: "max" }
...
export const fixture = {
  ...
  provider: {
    ...
    connected: ["OPENCRAFT"],
    default: { providerID: "OPENCRAFT", modelID: "claude-opus-4-6" },
  },
  sessions: [
    {
      id: sourceID,
