...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "OPENCRAFT Documentation", href: "https://OPENCRAFT.ai/docs" },
      { type: "item", label: "Support Forum", href: "https://discord.com/invite/OPENCRAFT" },
      { type: "separator" },
      {
        type: "item",
        label: "Share Feedback",
        href: "https://github.com/anomalyco/OPENCRAFT/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/anomalyco/OPENCRAFT/issues/new?template=bug_report.yml",
      },
    ],
  },
]
