...
export const loadMcpQuery = (directory: string, sdk: OPENCRAFTClient) =>
  queryOptions({
    queryKey: [directory, "mcp"] as const,
    queryFn: () => sdk.mcp.status().then((r) => r.data ?? {}),
  })

export const loadLspQuery = (directory: string, sdk: OPENCRAFTClient) =>
  queryOptions({
    queryKey: [directory, "lsp"] as const,
    queryFn: () => sdk.lsp.status().then((r) => r.data ?? []),
  })

function makeQueryOptionsApi(globalSDK: () => OPENCRAFTClient, sdkFor: (dir: PathKey) => OPENCRAFTClient) {
  return {
...
function createGlobalSync() {
  ...
  const sdkCache = new Map<string, OPENCRAFTClient>()
