export const dict = {
  ...
  "dialog.provider.OPENCRAFT.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.OPENCRAFT.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.OPENCRAFTGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje OPENCRAFT",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u OPENCRAFT-u.",
  ...
  "provider.connect.OPENCRAFTZen.line1":
    "OPENCRAFT Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.OPENCRAFTZen.visit.prefix": "Posjeti ",
  "provider.connect.OPENCRAFTZen.visit.link": "OPENCRAFT.ai/zen",
  "provider.connect.OPENCRAFTZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u OPENCRAFT-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u OPENCRAFT-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u OPENCRAFT.json",
  ...
  "dialog.server.description": "Promijeni na koji se OPENCRAFT server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija OPENCRAFT-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku OPENCRAFT timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (OPENCRAFT.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: OPENCRAFT još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "OPENCRAFT uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni OPENCRAFT server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u OPENCRAFT-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako OPENCRAFT izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li OPENCRAFT prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu OPENCRAFT-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se OPENCRAFT pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju OPENCRAFT-a.",
