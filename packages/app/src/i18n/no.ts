...
export const dict = {
  ...
  "dialog.provider.OPENCRAFT.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.OPENCRAFT.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.OPENCRAFTGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av OPENCRAFT",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i OPENCRAFT.",
  ...
  "provider.connect.OPENCRAFTZen.line1":
    "OPENCRAFT Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.OPENCRAFTZen.visit.prefix": "Besøk ",
  "provider.connect.OPENCRAFTZen.visit.link": "OPENCRAFT.ai/zen",
  "provider.connect.OPENCRAFTZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i OPENCRAFT.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i OPENCRAFT.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i OPENCRAFT.json",
  ...
  "dialog.server.description": "Bytt hvilken OPENCRAFT-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av OPENCRAFT ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til OPENCRAFT-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (OPENCRAFT.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at OPENCRAFT ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "OPENCRAFT inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør OPENCRAFT-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for OPENCRAFT",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan OPENCRAFT ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om OPENCRAFT skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan OPENCRAFT er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når OPENCRAFT starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av OPENCRAFT.",
