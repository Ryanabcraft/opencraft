...
export const dict = {
  ...
  "dialog.provider.OPENCRAFT.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.OPENCRAFT.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.OPENCRAFTGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "OPENCRAFT tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve OPENCRAFT'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.OPENCRAFTZen.line1":
    "OPENCRAFT Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.OPENCRAFTZen.visit.prefix": "",
  "provider.connect.OPENCRAFTZen.visit.link": "OPENCRAFT.ai/zen",
  "provider.connect.OPENCRAFTZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve OPENCRAFT'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak OPENCRAFT'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler OPENCRAFT.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi OPENCRAFT sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "OPENCRAFT'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı OPENCRAFT ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (OPENCRAFT.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: OPENCRAFT henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "OPENCRAFT ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "OPENCRAFT Masaüstü",
  ...
  "settings.desktop.wsl.description": "OPENCRAFT sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "OPENCRAFT'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "OPENCRAFT'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "OPENCRAFT'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "OPENCRAFT'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "OPENCRAFT başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "OPENCRAFT'un en son sürümünü kullanıyorsunuz.",
