export const dict = {
  ...
  "dialog.provider.OPENCRAFT.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.OPENCRAFT.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.OPENCRAFTGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo OPENCRAFT",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no OPENCRAFT.",
  ...
  "provider.connect.OPENCRAFTZen.line1":
    "OPENCRAFT Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.OPENCRAFTZen.visit.prefix": "Visite ",
  "provider.connect.OPENCRAFTZen.visit.link": "OPENCRAFT.ai/zen",
  "provider.connect.OPENCRAFTZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no OPENCRAFT.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no OPENCRAFT.",
  ...
  "dialog.plugins.empty": "Plugins configurados em OPENCRAFT.json",
  ...
  "dialog.server.description": "Trocar para qual servidor OPENCRAFT este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do OPENCRAFT ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do OPENCRAFT",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (OPENCRAFT.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: OPENCRAFT ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "OPENCRAFT inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor OPENCRAFT dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do OPENCRAFT",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o OPENCRAFT aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o OPENCRAFT segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o OPENCRAFT é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o OPENCRAFT iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do OPENCRAFT.",
