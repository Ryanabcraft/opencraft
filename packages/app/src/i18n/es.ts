export const dict = {
  ...
  "dialog.provider.OPENCRAFT.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.OPENCRAFT.tagline": "Modelos optimizados y fiables",
  "dialog.provider.OPENCRAFTGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por OPENCRAFT",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en OPENCRAFT.",
  ...
  "provider.connect.OPENCRAFTZen.line1":
    "OPENCRAFT Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.OPENCRAFTZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.OPENCRAFTZen.visit.prefix": "Visita ",
  "provider.connect.OPENCRAFTZen.visit.link": "OPENCRAFT.ai/zen",
  "provider.connect.OPENCRAFTZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en OPENCRAFT.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en OPENCRAFT.",
  ...
  "dialog.plugins.empty": "Plugins configurados en OPENCRAFT.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de OPENCRAFT se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de OPENCRAFT ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de OPENCRAFT",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (OPENCRAFT.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, OPENCRAFT no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "OPENCRAFT incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor OPENCRAFT dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para OPENCRAFT",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve OPENCRAFT en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si OPENCRAFT sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de OPENCRAFT.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia OPENCRAFT",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de OPENCRAFT.",
