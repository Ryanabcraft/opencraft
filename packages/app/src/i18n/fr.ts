export const dict = {
  ...
  "dialog.provider.OPENCRAFT.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.OPENCRAFT.tagline": "Modèles optimisés et fiables",
  "dialog.provider.OPENCRAFTGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par OPENCRAFT",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans OPENCRAFT.",
  ...
  "provider.connect.OPENCRAFTZen.line1":
    "OPENCRAFT Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  "provider.connect.OPENCRAFTZen.line2":
    "Avec une seule clé API, vous aurez accès à des modèles tels que Claude, GPT, Gemini, GLM et plus encore.",
  "provider.connect.OPENCRAFTZen.visit.prefix": "Visitez ",
  "provider.connect.OPENCRAFTZen.visit.link": "OPENCRAFT.ai/zen",
  "provider.connect.OPENCRAFTZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans OPENCRAFT.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans OPENCRAFT.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans OPENCRAFT.json",
  ...
  "dialog.server.description": "Changez le serveur OPENCRAFT auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'OPENCRAFT ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe OPENCRAFT",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (OPENCRAFT.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'OPENCRAFT ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "OPENCRAFT inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "app.name.desktop": "OPENCRAFT Desktop",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur OPENCRAFT dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour OPENCRAFT",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'OPENCRAFT sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si OPENCRAFT suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'OPENCRAFT.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'OPENCRAFT",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'OPENCRAFT.",
