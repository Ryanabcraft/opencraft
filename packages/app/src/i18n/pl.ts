export const dict = {
  ...
  "dialog.provider.OPENCRAFT.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.OPENCRAFT.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.OPENCRAFTGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez OPENCRAFT",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w OPENCRAFT.",
  ...
  "provider.connect.OPENCRAFTZen.line1":
    "OPENCRAFT Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.OPENCRAFTZen.visit.prefix": "Odwiedź ",
  "provider.connect.OPENCRAFTZen.visit.link": "OPENCRAFT.ai/zen",
  "provider.connect.OPENCRAFTZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w OPENCRAFT.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w OPENCRAFT.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w OPENCRAFT.json",
  ...
  "dialog.server.description": "Przełącz serwer OPENCRAFT, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja OPENCRAFT ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu OPENCRAFT",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (OPENCRAFT.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "OPENCRAFT zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla OPENCRAFT",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd OPENCRAFT na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy OPENCRAFT ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw OPENCRAFT.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania OPENCRAFT",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji OPENCRAFT.",
