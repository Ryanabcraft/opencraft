...
export const dict = {
  ...
  "dialog.provider.OPENCRAFT.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.OPENCRAFT.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.OPENCRAFTGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von OPENCRAFT",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in OPENCRAFT zu nutzen.",
  ...
  "provider.connect.OPENCRAFTZen.line1":
    "OPENCRAFT Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.OPENCRAFTZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.OPENCRAFTZen.visit.link": "OPENCRAFT.ai/zen",
  "provider.connect.OPENCRAFTZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in OPENCRAFT zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in OPENCRAFT zu nutzen.",
  ...
  "dialog.plugins.empty": "In OPENCRAFT.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den OPENCRAFT-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von OPENCRAFT ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem OPENCRAFT-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (OPENCRAFT.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: OPENCRAFT unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "OPENCRAFT enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "OPENCRAFT-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für OPENCRAFT ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie OPENCRAFT auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob OPENCRAFT dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von OPENCRAFT anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von OPENCRAFT automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von OPENCRAFT.",
