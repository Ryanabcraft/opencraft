export const dict = {
  ...
  "dialog.provider.OPENCRAFT.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.OPENCRAFT.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.OPENCRAFTGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af OPENCRAFT",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i OPENCRAFT.",
  ...
  "provider.connect.OPENCRAFTZen.line1":
    "OPENCRAFT Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.OPENCRAFTZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.OPENCRAFTZen.visit.prefix": "Besøg ",
  "provider.connect.OPENCRAFTZen.visit.link": "OPENCRAFT.ai/zen",
  "provider.connect.OPENCRAFTZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i OPENCRAFT.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i OPENCRAFT.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i OPENCRAFT.json",
  ...
  "dialog.server.description": "Skift hvilken OPENCRAFT-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af OPENCRAFT ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til OPENCRAFT-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (OPENCRAFT.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, OPENCRAFT understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "OPENCRAFT inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør OPENCRAFT-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for OPENCRAFT",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan OPENCRAFT ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om OPENCRAFT følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan OPENCRAFT er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når OPENCRAFT starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af OPENCRAFT.",
