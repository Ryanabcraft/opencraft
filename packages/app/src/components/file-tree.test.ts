...
beforeAll(async () => {
  ...
  mock.module("@OPENCRAFT-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@OPENCRAFT-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@OPENCRAFT-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@OPENCRAFT-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
