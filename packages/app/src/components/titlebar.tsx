...
import { Tooltip, TooltipKeybind } from "@OPENCRAFT-ai/ui/tooltip"
import { useTheme } from "@OPENCRAFT-ai/ui/theme/context"
import { IconButtonV2 } from "@OPENCRAFT-ai/ui/v2/components/icon-button-v2.jsx"
...
export function Titlebar() {
  ...
  const nav = createMemo(() => import.meta.env.VITE_OPENCRAFT_CHANNEL !== "beta" || settings.general.showNavigation())
  ...
  return (
    ...
    >
      <Switch>
        <Match when={import.meta.env.VITE_OPENCRAFT_CHANNEL !== "prod"}>
          {(_) => {
        ...
        <Match when>
          ...
          >
              ...
              <div class="flex items-center gap-1 shrink-0">
                ...
                <div class="hidden xl:flex items-center shrink-0">
                  ...
                  >
                    ...
                    <div id="OPENCRAFT-titlebar-left" class="flex items-center gap-3 min-w-0 px-2" />
                    <ChannelIndicator />
                  </div>
                </div>
              </div>
            ...
            <div
              ...
              onMouseDown={drag}
            >
              <div id="OPENCRAFT-titlebar-right" class="flex items-center gap-1 shrink-0 justify-end" />
              <Show when={windows()}>
...
function ChannelIndicator() {
  return (
    <>
      {["beta", "dev"].includes(import.meta.env.VITE_OPENCRAFT_CHANNEL) && (
        <div class="bg-icon-interactive-base text-[#FFF] font-medium px-2 rounded-sm uppercase font-mono">
          {import.meta.env.VITE_OPENCRAFT_CHANNEL.toUpperCase()}
        </div>
      )}
    </>
  )
