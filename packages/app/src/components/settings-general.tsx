...
import { Switch } from "@OPENCRAFT-ai/ui/switch"
        ...
        <SettingsRow
          ...
          description={
            <>
              ...
              <Link href="https://OPENCRAFT.ai/docs/themes/">{language.t("common.learnMore")}</Link>
            </>
          }
        >
          <Select
  ...
  return (
    <div class="flex flex-col h-full overflow-y-auto no-scrollbar px-4 pb-10 sm:px-10 sm:pb-10">
      ...
      <div class="flex flex-col gap-8 w-full">
        ...
        <Show when={desktop() && import.meta.env.VITE_OPENCRAFT_CHANNEL === "beta"}>
          <AdvancedSection />
        </Show>
      </div>
    </div>
