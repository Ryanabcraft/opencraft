...
import { LLM, LLMClient, Provider, ProviderID, Tool, type ProviderModelOptions } from "@OPENCRAFT-ai/llm"
import { Route, Auth, Endpoint, Framing, Protocol, RequestExecutor } from "@OPENCRAFT-ai/llm/route"
...
const rawOverlayExample = LLM.request({
  ...
  http: {
    ...
    headers: { "x-OPENCRAFT-tutorial": "1" },
    query: { debug: "1" },
  },
})
