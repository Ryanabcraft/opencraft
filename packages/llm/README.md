...
Schema-first LLM core for OPENCRAFT. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@OPENCRAFT-ai/llm"
import { OpenAI } from "@OPENCRAFT-ai/llm/providers"
...
```ts
import { Anthropic } from "@OPENCRAFT-ai/llm/providers"
