...
import { IconOPENCRAFT } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "OPENCRAFT/session/message-v2"
import type { Message } from "OPENCRAFT/session/message"
import type { Session } from "OPENCRAFT/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.OPENCRAFT_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.OPENCRAFT_name}>
                    <IconOPENCRAFT width={16} height={16} />
                  </div>
