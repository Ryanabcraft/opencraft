...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders OPENCRAFT_CALLER", () => {
    process.env["OPENCRAFT_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode OPENCRAFT_CALLER", () => {
    process.env["OPENCRAFT_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown OPENCRAFT_CALLER", () => {
    process.env["OPENCRAFT_CALLER"] = "unknown"
