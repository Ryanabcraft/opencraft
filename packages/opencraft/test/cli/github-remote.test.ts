...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/OPENCRAFT.git")).toEqual({ owner: "sst", repo: "OPENCRAFT" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/OPENCRAFT")).toEqual({ owner: "sst", repo: "OPENCRAFT" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/OPENCRAFT.git")).toEqual({ owner: "sst", repo: "OPENCRAFT" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/OPENCRAFT")).toEqual({ owner: "sst", repo: "OPENCRAFT" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/OPENCRAFT.git")).toEqual({ owner: "sst", repo: "OPENCRAFT" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/OPENCRAFT")).toEqual({ owner: "sst", repo: "OPENCRAFT" })
})
