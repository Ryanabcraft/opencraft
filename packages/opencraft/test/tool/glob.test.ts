  ...
  scout.instance(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const cache = path.join(Global.Path.repos, "github.com", "OPENCRAFT-glob-reference", "repo")
        ...
        const remoteDir = path.join(remoteRoot, "OPENCRAFT-glob-reference")
      ...
      }),
    {
      config: {
        reference: {
          docs: "OPENCRAFT-glob-reference/repo",
        },
      },
    },
  )
