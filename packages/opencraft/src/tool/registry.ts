...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@OPENCRAFT-ai/plugin"
...
export function webSearchEnabled(providerID: ProviderID, flags = { exa: false, parallel: false }) {
  return providerID === ProviderID.OPENCRAFT || flags.exa || flags.parallel
}
...
export class Service extends Context.Service<Service, Interface>()("@OPENCRAFT/ToolRegistry") {}
