...
export class Service extends Context.Service<Service, Interface>()("@OPENCRAFT/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __OPENCRAFT_PHOTON_WASM_PATH?: string }).__OPENCRAFT_PHOTON_WASM_PATH =
