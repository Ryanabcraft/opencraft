 ...
 *   "@OPENCRAFT/ServerAuthConfig",
 *   {
 *     password: Config.string("OPENCRAFT_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("OPENCRAFT_SERVER_USERNAME").pipe(Config.withDefault("OPENCRAFT")),
 *   },
 * ) {}
 *
