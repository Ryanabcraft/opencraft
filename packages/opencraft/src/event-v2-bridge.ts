...
// OPENCRAFT and the HTTP event stream still expect legacy bus/sync payloads.
...
import "@OPENCRAFT-ai/core/catalog"
import "@OPENCRAFT-ai/core/session-event"
...
export class Service extends Context.Service<Service, EventV2.Interface>()("@OPENCRAFT/EventV2Bridge") {}
