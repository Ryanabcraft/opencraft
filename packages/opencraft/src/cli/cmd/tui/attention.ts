...
} from "@OPENCRAFT-ai/plugin/tui"
import stripAnsi from "strip-ansi"
import type { TuiConfig } from "./config/tui"
import { isAttentionSoundName } from "./config/tui-schema"
import * as TuiAudio from "@tui/util/audio"
import defaultSoundPath from "@OPENCRAFT-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@OPENCRAFT-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@OPENCRAFT-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@OPENCRAFT-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@OPENCRAFT-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@OPENCRAFT-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "OPENCRAFT"
const DEFAULT_PACK_ID = "OPENCRAFT.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "OPENCRAFT Default",
  builtin: true,
  sounds: {
