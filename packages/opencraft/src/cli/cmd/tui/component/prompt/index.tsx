...
import type { AssistantMessage, FilePart, UserMessage } from "@OPENCRAFT-ai/sdk/v2"
...
import { OPENCRAFT_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useOPENCRAFTKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.OPENCRAFT_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
