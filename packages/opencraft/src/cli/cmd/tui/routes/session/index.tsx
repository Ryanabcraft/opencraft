...
import { OPENCRAFT_BASE_MODE, useBindings, useCommandShortcut, useOPENCRAFTKeymap } from "../../keymap"
...
const GO_UPSELL_PROVIDERS = new Set(["OPENCRAFT", "OPENCRAFT-go"])
  ...
  createEffect(() => {
    ...
    return exit.message.set(
      [
        ...
        `  ${weak("Continue")}${UI.Style.TEXT_NORMAL_BOLD}OPENCRAFT -s ${session()?.id}${UI.Style.TEXT_NORMAL}`,
        ``,
      ].join("\n"),
    )
  })
...
function ReasoningPart(props: { last: boolean; part: ReasoningPart; message: AssistantMessage }) {
  ...
  // OpenAI / Copilot / OPENCRAFT-via-OpenAI emit `**Title**\n\n<body>` summary
