...
//
// The saved variant persists across sessions in ~/.local/state/OPENCRAFT/model.json
...
class Service extends Context.Service<Service, VariantService>()("@OPENCRAFT/RunVariant") {}
