...
import type { OPENCRAFTClient, PermissionRequest, QuestionRequest, ToolPart } from "@OPENCRAFT-ai/sdk/v2"
...
type PromptModel = Parameters<OPENCRAFTClient["session"]["prompt"]>[0]["model"]
type PromptInput = Parameters<OPENCRAFTClient["session"]["prompt"]>[0]

export type RunPromptPart = NonNullable<PromptInput["parts"]>[number]

export type RunCommand = NonNullable<Awaited<ReturnType<OPENCRAFTClient["command"]["list"]>>["data"]>[number]

export type RunProvider = NonNullable<Awaited<ReturnType<OPENCRAFTClient["provider"]["list"]>>["data"]>["all"][number]
...
export type RunAgent = NonNullable<Awaited<ReturnType<OPENCRAFTClient["app"]["agents"]>>["data"]>[number]

type RunResourceMap = NonNullable<Awaited<ReturnType<OPENCRAFTClient["experimental"]["resource"]["list"]>>["data"]>
...
export type PermissionReply = Parameters<OPENCRAFTClient["permission"]["reply"]>[0]

export type QuestionReply = Parameters<OPENCRAFTClient["question"]["reply"]>[0]

export type QuestionReject = Parameters<OPENCRAFTClient["question"]["reject"]>[0]
