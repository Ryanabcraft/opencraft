...
import type { Event, GlobalEvent, OPENCRAFTClient } from "@OPENCRAFT-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@OPENCRAFT/RunStreamTransport") {}
