import type * as SDK from "@OPENCRAFT-ai/sdk/v2"
...
const disabled = process.env["OPENCRAFT_DISABLE_SHARE"] === "true" || process.env["OPENCRAFT_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@OPENCRAFT/ShareNext") {}
