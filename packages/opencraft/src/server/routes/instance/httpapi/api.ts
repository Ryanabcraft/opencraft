...
export const RootHttpApi = HttpApi.make("OPENCRAFT-root")
  .addHttpApi(ControlApi)
  .addHttpApi(GlobalApi)
  .middleware(SchemaErrorMiddleware)
  .middleware(Authorization)

export const InstanceHttpApi = HttpApi.make("OPENCRAFT-instance")
...
export const OPENCRAFTHttpApi = HttpApi.make("OPENCRAFT")
