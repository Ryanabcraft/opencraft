...
>()("@OPENCRAFT/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@OPENCRAFT/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceID | undefined {
  return Flag.OPENCRAFT_WORKSPACE_ID ? WorkspaceID.make(Flag.OPENCRAFT_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-OPENCRAFT-directory"] || process.cwd()
}
