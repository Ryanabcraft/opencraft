...
import { NonNegativeInt, PositiveInt } from "@OPENCRAFT-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@OPENCRAFT/Pty") {}
