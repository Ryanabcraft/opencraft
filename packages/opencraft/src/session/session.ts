import { Slug } from "@OPENCRAFT-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@OPENCRAFT-ai/llm"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".OPENCRAFT", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@OPENCRAFT/Session") {}
