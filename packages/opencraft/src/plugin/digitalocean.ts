import type { Hooks, PluginInput } from "@OPENCRAFT-ai/plugin"
import type { Model } from "@OPENCRAFT-ai/sdk/v2"
...
const MAK_NAME_PREFIX = "OPENCRAFT-oauth"
...
<html>
  <head>
    <meta charset="utf-8" />
    <title>OPENCRAFT - DigitalOcean Authorization</title>
    <style>
    ...
    <script>
      (async function() {
        ...
        try {
          ...
          msgEl.textContent = "You can close this window and return to OPENCRAFT."
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              ...
              instructions:
                "Sign in to DigitalOcean in your browser. OPENCRAFT will create a Model Access Key named OPENCRAFT-oauth-* and load your Inference Routers. Re-run /connect to refresh routers later.",
