...
import { sanitizedProcessEnv } from "@OPENCRAFT-ai/core/util/OPENCRAFT-process"
import { which } from "@/util/which"
import { NonNegativeInt } from "@OPENCRAFT-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@OPENCRAFT/Ripgrep") {}
    ...
    Effect.gen(function* () {
      ...
      const tree: Interface["tree"] = Effect.fn("Ripgrep.tree")(function* (input: TreeInput) {
        ...
        for (const file of list) {
          if (file.includes(".OPENCRAFT")) continue
