...
export class Service extends Context.Service<Service, Interface>()("@OPENCRAFT/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        OPENCRAFT_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        OPENCRAFT_WORKSPACE_ID: config.id,
        OPENCRAFT_EXPERIMENTAL_WORKSPACES: "true",
