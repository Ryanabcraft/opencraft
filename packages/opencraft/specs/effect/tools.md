...
Practical reference for the current tool-migration state in `packages/OPENCRAFT`.
...
Tool tests should use the existing Effect helpers in `packages/OPENCRAFT/test/lib/effect.ts`:
