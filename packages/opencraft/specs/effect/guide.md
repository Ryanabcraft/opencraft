...
How we write Effect code in `packages/OPENCRAFT`. The companion roadmap is
[`todo.md`](./todo.md).
...
export class Service extends Context.Service<Service, Interface>()("@OPENCRAFT/Foo") {}
...
Read OPENCRAFT runtime flags through
