...
import { and, Database, eq, isNull, lt, or, sql } from "@OPENCRAFT-ai/console-core/drizzle/index.js"
import { KeyTable } from "@OPENCRAFT-ai/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@OPENCRAFT-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@OPENCRAFT-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@OPENCRAFT-ai/console-core/util/date.js"
import { Identifier } from "@OPENCRAFT-ai/console-core/identifier.js"
import { Billing } from "@OPENCRAFT-ai/console-core/billing.js"
import { Actor } from "@OPENCRAFT-ai/console-core/actor.js"
import { WorkspaceTable } from "@OPENCRAFT-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@OPENCRAFT-ai/console-core/model.js"
import { Subscription } from "@OPENCRAFT-ai/console-core/subscription.js"
import { BlackData } from "@OPENCRAFT-ai/console-core/black.js"
import { UserTable } from "@OPENCRAFT-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@OPENCRAFT-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@OPENCRAFT-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@OPENCRAFT-ai/console-core/lite.js"
import { Resource } from "@OPENCRAFT-ai/console-resource"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-OPENCRAFT-session") ?? ""
    const requestId = input.request.headers.get("x-OPENCRAFT-request") ?? ""
    const projectId = input.request.headers.get("x-OPENCRAFT-project") ?? ""
    const ocClient = input.request.headers.get("x-OPENCRAFT-client") ?? ""
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-OPENCRAFT-request")
          headers.delete("x-OPENCRAFT-session")
          headers.delete("x-OPENCRAFT-project")
          headers.delete("x-OPENCRAFT-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (opts.modelList === "lite" && authInfo.billing.lite && authInfo.lite) {
      try {
        const consoleGoUrl = `https://OPENCRAFT.ai/workspace/${authInfo.workspaceID}/go`
    ...
    const billingUrl = `https://OPENCRAFT.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://OPENCRAFT.ai/workspace/${authInfo.workspaceID}/members`
