...
import compareVideo from "../../asset/lander/OPENCRAFT-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/OPENCRAFT-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="OPENCRAFT:auth" content={loggedin() ? "true" : "false"} />
