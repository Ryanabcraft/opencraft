...
import desktopAppIcon from "../../asset/lander/OPENCRAFT-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://OPENCRAFT.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>OPENCRAFT.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g OPENCRAFT-ai")}>
                <code>
                  npm i -g <strong>OPENCRAFT-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g OPENCRAFT-ai")}>
                <code>
                  bun add -g <strong>OPENCRAFT-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/OPENCRAFT")}>
                <code>
                  brew install <strong>anomalyco/tap/OPENCRAFT</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S OPENCRAFT")}>
                <code>
                  paru -S <strong>OPENCRAFT</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask OPENCRAFT-desktop")}>
                <code>
                  brew install --cask <strong>OPENCRAFT-desktop</strong>
                </code>
                <CopyStatus />
              </button>
