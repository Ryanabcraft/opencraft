...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new OPENCRAFTClient()" to fix this error.`)
    }
    return instance
  }
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the OPENCRAFT system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the OPENCRAFT system.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global OPENCRAFT configuration settings and preferences.
   */
   ...
   *
   * Update global OPENCRAFT configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the OPENCRAFT server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the OPENCRAFT system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all OPENCRAFT instances, releasing all resources.
   */
   ...
   * Upgrade OPENCRAFT
   *
   * Upgrade OPENCRAFT to the specified version or latest if not specified.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current OPENCRAFT configuration settings and preferences.
   */
   ...
   *
   * Update OPENCRAFT configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local OPENCRAFT state.
   */
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current OPENCRAFT instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the OPENCRAFT system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with OPENCRAFT.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that OPENCRAFT is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by OPENCRAFT.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all OPENCRAFT sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new OPENCRAFT session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific OPENCRAFT session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class OPENCRAFTClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<OPENCRAFTClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    OPENCRAFTClient.__registry.set(this, args?.key)
  }
