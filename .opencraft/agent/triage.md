...
Desktop application and browser-based app issues, including `OPENCRAFT web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core OPENCRAFT server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

OPENCRAFT Zen, OPENCRAFT Go, and billing issues.
