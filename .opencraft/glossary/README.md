...
Use this folder for locale-specific translation guidance that supplements `.OPENCRAFT/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/OPENCRAFT/pull/12345

## Do Not Translate (Locale Additions)

- `OPENCRAFT` (preserve casing)
