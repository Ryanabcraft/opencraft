...
- PR #10809: https://github.com/anomalyco/OPENCRAFT/pull/10809
- PR #11496: https://github.com/anomalyco/OPENCRAFT/pull/11496

## Do Not Translate (Locale Additions)

- `OPENCRAFT` (preserve casing in prose; keep `OPENCRAFT` only in commands, package names, paths, or code)
- `OPENCRAFT CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
