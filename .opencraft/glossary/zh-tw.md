...
- PR #13942: https://github.com/anomalyco/OPENCRAFT/pull/13942

## Do Not Translate (Locale Additions)

- `OPENCRAFT` (preserve casing in prose; keep `OPENCRAFT` only when it is part of commands, package names, paths, or code)
- `OPENCRAFT Zen`
- `OPENCRAFT CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `OPENCRAFT` in prose when referring to the product name; use `OPENCRAFT`
