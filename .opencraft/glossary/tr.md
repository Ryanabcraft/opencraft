...
- PR #15835: https://github.com/anomalyco/OPENCRAFT/pull/15835

## Do Not Translate (Locale Additions)

- `OPENCRAFT` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `OPENCRAFT` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `OPENCRAFT` in prose, `OPENCRAFT` only for exact technical identifiers
...
- Avoid changing `OPENCRAFT` to `OPENCRAFT` inside commands, URLs, package names, or code literals
