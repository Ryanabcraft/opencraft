...
brew install anomalyco/tap/OPENCRAFT # macOS og Linux (anbefalet, altid up to date)
brew install OPENCRAFT              # macOS og Linux (officiel brew formula, opdateres sjældnere)
...
OPENCRAFT findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/anomalyco/OPENCRAFT/releases) eller [OPENCRAFT.ai/download](https://OPENCRAFT.ai/download).
...
1. `$OPENCRAFT_INSTALL_DIR` - Tilpasset installationsmappe
...
OPENCRAFT har to indbyggede agents, som du kan skifte mellem med `Tab`-tasten.
...
Læs mere om [agents](https://OPENCRAFT.ai/docs/agents).

### Dokumentation

For mere info om konfiguration af OPENCRAFT, [**se vores docs**](https://OPENCRAFT.ai/docs).

### Bidrag

Hvis du vil bidrage til OPENCRAFT, så læs vores [contributing docs](./CONTRIBUTING.md) før du sender en pull request.

### Bygget på OPENCRAFT

Hvis du arbejder på et projekt der er relateret til OPENCRAFT og bruger "OPENCRAFT" som en del af navnet; f.eks. "OPENCRAFT-dashboard" eller "OPENCRAFT-mobile", så tilføj en note i din README, der tydeliggør at projektet ikke er bygget af OPENCRAFT-teamet og ikke er tilknyttet os på nogen måde.

---

**Bliv en del af vores community** [Discord](https://discord.gg/OPENCRAFT) | [X.com](https://x.com/OPENCRAFT)
