...
# Package managers
npm i -g OPENCRAFT-ai@latest        # or bun/pnpm/yarn
scoop install OPENCRAFT             # Windows
choco install OPENCRAFT             # Windows
brew install anomalyco/tap/OPENCRAFT # macOS and Linux (recommended, always up to date)
brew install OPENCRAFT              # macOS and Linux (official brew formula, updated less)
sudo pacman -S OPENCRAFT            # Arch Linux (Stable)
paru -S OPENCRAFT-bin               # Arch Linux (Latest from AUR)
mise use -g OPENCRAFT               # Any OS
nix run nixpkgs#OPENCRAFT           # or github:anomalyco/OPENCRAFT for latest dev branch
```
...
OPENCRAFT ডেস্কটপ অ্যাপ্লিকেশন হিসেবেও উপলব্ধ। সরাসরি [রিলিজ পেজ](https://github.com/anomalyco/OPENCRAFT/releases) অথবা [OPENCRAFT.ai/download](https://OPENCRAFT.ai/download) থেকে ডাউনলোড করুন।
...
1. `$OPENCRAFT_INSTALL_DIR` - কাস্টম ইনস্টলেশন ডিরেক্টরি
...
4. `$HOME/.OPENCRAFT/bin` - ডিফল্ট ফলব্যাক
...
OPENCRAFT এ দুটি বিল্ট-ইন এজেন্ট রয়েছে যা আপনি `Tab` কি(key) দিয়ে পরিবর্তন করতে পারবেন।
...
এজেন্টদের সম্পর্কে আরও জানুন: [docs](https://OPENCRAFT.ai/docs/agents)।

### ডকুমেন্টেশন (Documentation)

কিভাবে OPENCRAFT কনফিগার করবেন সে সম্পর্কে আরও তথ্যের জন্য, [**আমাদের ডকস দেখুন**](https://OPENCRAFT.ai/docs)।

### অবদান (Contributing)

আপনি যদি OPENCRAFT এ অবদান রাখতে চান, অনুগ্রহ করে একটি পুল রিকোয়েস্ট সাবমিট করার আগে আমাদের [কন্ট্রিবিউটিং ডকস](./CONTRIBUTING.md) পড়ে নিন।

### OPENCRAFT এর উপর বিল্ডিং (Building on OPENCRAFT)

আপনি যদি এমন প্রজেক্টে কাজ করেন যা OPENCRAFT এর সাথে সম্পর্কিত এবং প্রজেক্টের নামের অংশ হিসেবে "OPENCRAFT" ব্যবহার করেন, উদাহরণস্বরূপ "OPENCRAFT-dashboard" বা "OPENCRAFT-mobile", তবে দয়া করে আপনার README তে একটি নোট যোগ করে স্পষ্ট করুন যে এই প্রজেক্টটি OPENCRAFT দল দ্বারা তৈরি হয়নি এবং আমাদের সাথে এর কোনো সরাসরি সম্পর্ক নেই।

---

**আমাদের কমিউনিটিতে যুক্ত হোন** [Discord](https://discord.gg/OPENCRAFT) | [X.com](https://x.com/OPENCRAFT)
